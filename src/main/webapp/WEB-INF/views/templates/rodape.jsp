...
<footer class="footer">
	<div class="container bottom_border">
		<div class="row">
			<div class=" col-sm-4 col-md col-sm-4  col-12 col">
				...
				<p>
					<i class="fa fa-location-arrow"></i> Cubo Itau
				</p>
				<p>
					<i class="fa fa-phone"></i> +55 (11) xxxx-xxxx
				</p>
				<p>
					<i class="fa fa fa-envelope"></i> info@agoapp.com.br
				</p>
			...
			<div class=" col-sm-4 col-md  col-6 col">
				<h5 class="headin5_amrc col_white_amrc pt2">Acesso rápido</h5>
				<!--headin5_amrc-->
	...
	<div class="container">
		...
		<p class="text-center">
			Copyright @2019 | Designed by <a href="#">AGO APP</a>
		</p>
